    ...
    with open('files/html.txt', 'w') as f:
        for html_url in html_url_list:
            ...
            headers = {
                ...
                'Cookie': 'UM_distinctid=1663a91df220-0f5b619c6ecd7-9393265-144000-1663a91df2310d; bdshare_firstime=1538580940053; safedog-flow-item=; CNZZDATA30056528=cnzz_eid%3D629189995-1538579398-http%253A%252F%252Fwww.meizitu.com%252F%26ntime%3D1538909833',
            }
...
def image_deal(image_url_list):
    """图片处理"""
    with open('files/image.txt', 'w') as f:
